...
(define const int32_t NTDS_EI_EOR 3 )
(define const int32_t NTDS_EI_PTR 6 )
(define const int32_t NTDS_EI_PTTB 7 )
(define const int32_t NTDS_EI_PTTD 5 )
(define const int32_t NTDS_EI_RESET 2 )
(define const int32_t TM_INVALID_NTN -1 )
(define const uint8_t DTSCTRL_EOM #x03 )
(define const uint8_t DTSCTRL_EXTRA #xFF )
(define const uint8_t DTSCTRL_SOM #x02 )
(define const unsigned int MAXIMUM_OF_TRAINING_TRACKS 0177 )
