...
g++ -w -fpic -pedantic -I. -It:/gitdir/DLP_LINK11/src/include -It:/gitdir/DLP_LINK11/src/common -It:/ICMS/devenv/icmsdlpcachelib/include -It:\gitdir\DLP_LINK11\src\ntds_drv -It:\ICMS\devenv\icmslib\include -c  -Wno-char-subscripts -O -DSTANDALONE=1 -DUSE_INTERFACE=1  -DUSE_STRLWR=0 -DUSE_STRCASECMP=0 -DUSE_DL=0 -DUSE_MATH=1 -DUSE_ASCII_NAMES=0  testsc.cpp
...
g++ -w -fpic -pedantic -I. -It:/gitdir/DLP_LINK11/src/include -It:/gitdir/DLP_LINK11/src/common -It:/ICMS/devenv/icmsdlpcachelib/include -It:\gitdir\DLP_LINK11\src\ntds_drv -It:\ICMS\devenv\icmslib\include -c  -Wno-char-subscripts -O -DSTANDALONE=0 -DUSE_INTERFACE=1  -DUSE_STRLWR=0 -DUSE_STRCASECMP=0 -DUSE_DL=0 -DUSE_MATH=1 -DUSE_ASCII_NAMES=0  testsc.cpp
