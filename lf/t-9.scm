...
(case (testsc-get-testnum)
  ...
  ((2)
   (tnset 1 '_track_source_filter 0)
  ...
  ((6)
   ...
   (tnset 1 'general.NTN 0)
   (tnset 1 'general.track_kind   system_types-track_kind_air_point_track )
   (tnset 1 'general.secondary_air_id_ampl  system_types-sec_air_ampl_interceptor)
   (tnset 1 'general.identity   system_types-identity_friend ))
