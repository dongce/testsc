...
** [[scheme_file][scheme 파일]] 작성 <<make_scheme_file>>
   ...
   2. [[test_variable][테스트 변수]] 및 [[testsc_struct][testsc 구조체]]를 선언 한다. 
   ...
   3. [[scheme_test_script][scheme 파일 작성]]부분을 참조하여 *TESTCASENO* 에 따라  [[test_variable][테스트 변수]] 및
      [[testsc_struct][testsc 구조체]]를 설정한다. 
